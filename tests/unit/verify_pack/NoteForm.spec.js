...
describe('verify_pack.NoteForm Component', () => {
    let wrapper, note;
    ...
    it('should display empty title and note form input fields when a new note is being created', () => {
        // given
        note = {}
        wrapper = mount(NoteForm, {
            propsData: {
        ...
        expect(wrapper.findAll('textarea').at(0).element.value).toEqual('')
    })
